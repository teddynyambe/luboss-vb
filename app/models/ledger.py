from sqlalchemy import Column, String, ForeignKey, DateTime, Numeric, Enum as SQLEnum, Boolean, Text, Index
...
class JournalEntry(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    entry_date = Column(DateTime, nullable=False, server_default="now()", index=True)
